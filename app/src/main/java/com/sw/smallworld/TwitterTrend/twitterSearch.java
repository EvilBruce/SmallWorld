...
public class twitterSearch extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bundle hashtagString = getIntent().getExtras();
        String hashtag = hashtagString.getString("hashtag");
        SEARCH_QUERY ="#".concat(hashtag);
        final SearchService service = Twitter.getApiClient().getSearchService();
        if(SEARCH_QUERY==null)SEARCH_QUERY = "NBA";
